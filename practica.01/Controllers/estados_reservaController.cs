...
namespace WebApiPractica.Controllers
{
    ...
    public class estados_reservaController : ControllerBase
    {
        ...
        {
            List<estados_reserva> listEstado = (from e in _equiposContext.estados_reserva
                                                select e).ToList();
        ...
        {
            estados_reserva? estados_ = (from e in _equiposContext.estados_reserva
        ...
        public IActionResult GuardarEstadoR([FromBody] estados_reserva estados_)
        {
            try
            {
                _equiposContext.estados_reserva.Add(estados_);
        ...
        {
            estados_reserva? estados_Actual = (from e in _equiposContext.estados_reserva
                                               where e.estado_res_id == id
                                               select e).FirstOrDefault();
        ...
        public IActionResult EliminarEstadoR(int id)
        {
            ...
            _equiposContext.estados_reserva.Attach(estados_);
            _equiposContext.estados_reserva.Remove(estados_);
            _equiposContext.SaveChanges();
